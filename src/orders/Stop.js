...
export default class {
  constructor({ account, action, quantity, stopPrice, parentId, transmitOrder, tif, outsideRth }) {
    ...
    validateInput(typeof stopPrice === 'number', 'Stop Price must be a number.')
    if (parentId)
      validateInput(
    ...
    this.orderType = ORDER_TYPE.STOP
